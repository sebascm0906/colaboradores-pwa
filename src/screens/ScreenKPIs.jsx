        ...
        <div style={{ position:"relative", width:120, height:60, margin:"0 auto 12px" }}>
          <svg width="120" height="60" viewBox="0 0 120 60">
            ...
            <path d="M10,60 A50,50 0 0,1 110,60" fill="none" stroke={pctColor} strokeWidth="10" strokeLinecap="round"
              strokeDasharray={`${animVal * data.pct * 1.571} 200`}  {/* 1.571 ≈ Math.PI/2 = perímetro_arco_100% cuando r=50. Si cambias r, recalcula: Math.PI * r / 100 */}
...
/* ============================================================================
   ROOT
============================================================================ */
export default function MultiDeviceKPIPreview() {
  return (
