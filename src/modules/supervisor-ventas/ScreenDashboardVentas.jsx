...
export default function ScreenDashboardVentas() {
  ...
  const metabaseUrl = import.meta.env.VITE_METABASE_URL || 'https://bi.grupofrio.mx'
  const hasUrl = !!import.meta.env.VITE_METABASE_URL || true // default fallback is valid
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '0 16px', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, paddingTop: 20, paddingBottom: 12 }}>
          ...
          <span style={{ ...typo.title, color: TOKENS.colors.textSoft }}>Dashboard Ventas</span>
        </div>
      </div>
